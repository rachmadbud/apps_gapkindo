...
@section('content')
    ...
    @else
        <div class="card card-dark">
            ...
            @if (isset($suratMasuk))
                <form id="quickForm" action="{{ app(CustomClass::class)->rootApp() }}/form/suratMasuk/edit" method="post"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="date" class="form-control @if ($errors->has('tanggal')) is-invalid @endif "
                            name="tanggal" value="{{ old('tanggal', isset($suratMasuk) ? $suratMasuk->tanggal : '') }}"
                            required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @if ($errors->has('nomorAgenda')) is-invalid @endif"
                            name="nomorAgenda"
                            value="{{ isset($suratMasuk) ? $suratMasuk->nomor_agenda : '' }} {{ old('nomorAgenda') }}"
                            required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @if ($errors->has('nomorSurat')) is-invalid @endif"
                            name="nomorSurat"
                            value="{{ isset($suratMasuk) ? $suratMasuk->nomor_surat : '' }} {{ old('nomorSurat') }}"
                            required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @if ($errors->has('pengirim')) is-invalid @endif"
                            name="pengirim"
                            value="{{ isset($suratMasuk) ? $suratMasuk->pengirim : '' }} {{ old('pengirim') }}" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @if ($errors->has('perihal')) is-invalid @endif"
                            name="perihal"
                            value="{{ isset($suratMasuk) ? $suratMasuk->perihal : '' }} {{ old('perihal') }}" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Lampiran</label>
                    <div class="col-sm-10">
                        <input type="file" class="form-control @if ($errors->has('file_surat')) is-invalid @endif"
                            name="file_surat" value="{{ isset($suratMasuk) ? $suratMasuk->file_surat : '' }}">
            ...
            <div class="card-footer">
                ...
                <button type="submit" class="btn btn-primary" name="button"
                    value="submit">{{ isset($suratMasuk) ? 'Update' : 'Submit' }}</button>
