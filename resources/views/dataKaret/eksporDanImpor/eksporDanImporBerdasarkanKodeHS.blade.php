...
@section('content')
    ...
    @else
        <div class="container-fluid">
            <h3 class="text-black-50">Ekspor Berdasarkan Kode HS</h3>
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="/fileExcel/{{ app(CustomClass::class)->enkrip($item->id) }}/ekspor-berdasarkan-kode-hs"
                                        ...
                                        <div class="modal fade" id="exampleModal{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form
                                                        action="{{ app(CustomClass::class)->rootApp() }}/ekspor-dan-impor-berdasarkan-kode-hs/{{ app(CustomClass::class)->enkrip($item->id) }}"
