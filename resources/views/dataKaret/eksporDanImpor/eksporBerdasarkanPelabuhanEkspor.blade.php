...
@section('content')
    ...
    @else
        <div class="container-fluid">
            <h3 class="text-black-50">Ekspor Berdasarkan Pelabuhan Ekspor</h3>
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="/fileExcel/{{ app(CustomClass::class)->enkrip($item->id) }}/ekspor-berdasarkan-pelabuhan-ekspor/lihat"
                                        ...
                                        <div class="modal fade" id="exampleModal{{ $item->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form
                                                        action="{{ app(CustomClass::class)->rootApp() }}/ekspor-berdasarkan-pelabuhan-ekspor/{{ app(CustomClass::class)->enkrip($item->id) }}"
